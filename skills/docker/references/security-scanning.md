...
## Table of Contents
1. [Security Hardening in Dockerfile](#hardening)
2. [Linux Capabilities](#capabilities)
3. [Read-only Filesystem](#readonly)
4. [Trivy — Vulnerability Scanning](#trivy)
5. [Grype — Alternative Scanner](#grype)
6. [SBOM Generation (syft)](#sbom)
7. [Docker Scout](#scout)
8. [Image Signing (cosign)](#cosign)
9. [Supply Chain Security (SLSA)](#slsa)
10. [Docker Content Trust (DCT) — deprecated](#dct)
11. [Security Checklist](#checklist)

---

## Security Hardening in Dockerfile {#hardening}
...
## Grype — Alternative Scanner {#grype}
...
## Supply Chain Security (SLSA) {#slsa}
...
## Docker Content Trust (DCT) — deprecated {#dct}
...
- **cosign (Sigstore)** — the de-facto standard for OCI image signing today (keyless
  ...
  (see [Image Signing (cosign)](#cosign)).
